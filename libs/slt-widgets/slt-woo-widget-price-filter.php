...
class vel_woo_widget_price_filter extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Shows a price filter slider in a widget which lets you narrow down the list of shown products when viewing product categories.', 'sellertemplate' );
		$this->widget_id          = 'woocommerce_price_filter';
		$this->widget_name        = __( 'SLT WooCommerce Price Filter', 'sellertemplate' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Filter by price', 'sellertemplate' ),
				'label' => __( 'Title', 'sellertemplate' )
			)
		);
		...
		echo '<form method="get" action="' . esc_url( $form_action ) . '">
			<div class="price_slider_wrapper">
				<div class="price_slider_amount">
					<input type="text" id="min_price" name="min_price" value="' . esc_attr( $min_price ) . '" data-min="' . esc_attr( apply_filters( 'woocommerce_price_filter_widget_min_amount', $min ) ) . '" placeholder="' . esc_attr__('Min price', 'sellertemplate' ) . '" />
					<input type="text" id="max_price" name="max_price" value="' . esc_attr( $max_price ) . '" data-max="' . esc_attr( apply_filters( 'woocommerce_price_filter_widget_max_amount', $max ) ) . '" placeholder="' . esc_attr__( 'Max price', 'sellertemplate' ) . '" />
				...
				<button type="submit" class="button">' . __( 'Submit', 'sellertemplate' ) . '</button>
			</div>
		</form>';
