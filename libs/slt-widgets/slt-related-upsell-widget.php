...
/**
	...
	* @version     1.0.0
**/
if ( !class_exists('vel_related_upsell_widget') ) {
	class vel_related_upsell_widget extends WP_Widget {
		/**
		 * Widget setup.
		 */
		function __construct(){
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'vel_related_upsell_widget', 'description' => __('SLT Woocommerce Related & Upsell Slider', 'yatheme') );

			/* Widget control settings. */
			$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'vel_related_upsell_widget' );

			/* Create the widget. */
			parent::__construct( 'vel_related_upsell_widget', __('SLT Woocommerce Related & Upsell Slider widget', 'yatheme'), $widget_ops, $control_ops );
		...
		protected function getTemplatePath($tpl='default', $type=''){
			$file = '/'.$tpl.$type.'.php';
			$dir =	plugin_dir_path(dirname(__FILE__)).'/themes/vel-reup-slider';
