...
class slt_brands_WC_Admin_Taxonomies {
	...
	public function __construct() {
		...
		add_action( 'add_meta_boxes',array( $this,  'slt_woocommerce_brands_add_meta_box'));
	}


	 public function slt_woocommerce_brands_add_meta_box() {
		 add_meta_box( 'mytaxonomy_id', 'Brands',array( $this,'slt_woocommerce_brands_metabox'),'product' ,'side','core');
	 }

	public function slt_woocommerce_brands_metabox( $post ) {
		...
		<div id="taxonomy-<?php echo $taxonomy; ?>" class="vel_brands">
	...
	public function create_taxonomies() {
		...
		$args = array(
			...
			'rewrite' 				=> array( 'slug' => $brands_base . __( 'brand', 'woocommerce-brands' ), 'with_front' => false, 'hierarchical' => true )
		);
...
new slt_brands_WC_Admin_Taxonomies();
?>