<?php
	...
	/* 	add_filter(  'posts_where', 'hurama_filter_where' );
	function hurama_filter_where( $where ) {
	...
	remove_filter( 'posts_where', 'hurama_filter_where' ); */
						...
						<div class="item-wrap">
							<div class="item-detail">
								<div class="item-top">
									...
									<span class="item-total-sales"><?php echo $total_sale[$i] .__( ' sale(s)', TEXTDOMAIN ); ?></span>
								</div>
								...
								<div class="item-content">
									...
									<?php $bt_cart = apply_filters( 'woocommerce_loop_add_to_cart_link',
