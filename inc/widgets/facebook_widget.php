...
add_action( 'widgets_init', 'slt_facebook_load_widget' );

function slt_facebook_load_widget() {
	register_widget( 'slt_facebook_widget' );
}

class slt_facebook_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function slt_facebook_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'slt_facebook_widget', 'description' => __('A widget that displays a Facebook Like Box', 'slt_facebook_widget') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'slt_facebook_widget' );

		/* Create the widget. */
		parent::__construct( 'slt_facebook_widget', __('SLT: Facebook Like Box', 'slt_facebook_widget'), $widget_ops, $control_ops );
	}
